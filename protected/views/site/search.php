                        ...
                        <table class="all-courses">
                            <?php foreach ($threads as $thread):?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="right">
                                            <img style="border-radius: 50%; width: 70px; height: 70px; max-height: 70px; max-width: 70px" src="<?php echo $thread->posts[0]->author->sdoUser->getAvatarPath(AVATAR_SIZE_MEDIUM); ?>">
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
