    ...
    <div class="form">
        ...
        <div class="row">
            ...
            <div class = "dateAccess" data-id ="<?php echo $model->id?>" style="display: inline">
                ...
                <?php echo CHtml::textField('AccessLearnMaterial[startDate]',DateHelper::getRussianDateFromDatabase($model->startDate,true),array('class' => 'dateTimePicker', 'onchange' => 'ajaxUpdateAccess(this);'));?>
