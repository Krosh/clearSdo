        ...
        <div class="row">
            ...
            <table class = "dateAccess" data-id ="<?php echo $model->id?>" style="width: 100%">
                <tr>
                    ...
                    <td><?php echo CHtml::textField('AccessLearnMaterial[startDate]',DateHelper::getRussianDateFromDatabase($model->startDate,true),array('class' => 'dateTimePicker', 'onchange' => 'ajaxUpdateAccess(this);'));?></td>
                </tr>
                <tr class = "endDateDiv">
                    <td style="width: 160px">
                    ...
                    <td>
                        <?php echo CHtml::textField('AccessLearnMaterial[endDate]',DateHelper::getRussianDateFromDatabase($model->endDate,true),array('class' => 'dateTimePicker', 'onchange' => 'ajaxUpdateAccess(this);'));?>
