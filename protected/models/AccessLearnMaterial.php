...
/**
 * This is the model class for table "tbl_accesslearnmaterials".
 *
 * The followings are the available columns in table 'tbl_accesslearnmaterials':
 * @property integer $id
 * @property integer $type_relation
 * @property integer $idRecord
 * @property integer $idCourse
 * @property integer $idLearnMaterial
 ...
 */
class AccessLearnMaterial extends CActiveRecord
{
	...
	{
		return 'tbl_accesslearnmaterials';
	}
    ...
    public function behaviors(){
        return array(
            'logBehavior' => array(
                'class' => 'LogBehavior',
                'tableName' => 'Доступ к учебным. материалам',
            ),
        );
    }
	...
	public function rules()
	{
		...
		return array(
			array('type_relation, idRecord, idCourse, idLearnMaterial, accessType, idBeforeMaterial, minMark, addTryes', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, type_relation, idRecord, idCourse,  idLearnMaterial, accessType, startDate, endDate, idBeforeMaterial, minMark, addTryes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'idRecord' => 'Id Record',
			'idCourse' => 'Id Course',
			'idLearnMaterial' => 'Id Learn Material',
	...
	public function search()
	{
		...
		$criteria->compare('idLearnMaterial',$this->idLearnMaterial);
