...
class UserAnswer extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('answer, showTime', 'length', 'max'=>450),
            array('answerTime, showTime', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, idUserControlMaterial, idQuestion, answer, answerTime, showTime', 'safe', 'on'=>'search'),
        );
    }
    ...
    {
        return strtotime($this->answerTime)-strtotime($this->showTime);
    }

    public function getFormattedAnswerTime()
    {
        return DateHelper::getDifferenceTime($this->showTime, $this->answerTime);
    }
}
