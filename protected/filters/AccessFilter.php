...
//        Yii::app()->clientScript->registerCoreScript('jquery.ui');
        ...
        $rules[ROLE_TEACHER] = array_merge($rules[ROLE_STUDENT],array("deleteAllNonUsedMaterials","getUserAnswer","getUserAnswers","getTimetable","changeTitle","changeAccess","plugin","upload","saveWeights","loadStudentsFromExcel","fullDeleteMaterial","mediateka","recalcMarks","journal","editCourse","addTeacherToCourse","getTeachers","deleteTeacher","addGroupToCourse","getGroups","deleteGroup","addMaterial","getMaterials","addExistMaterial","deleteMaterial","orderMaterial","create","edit","getQuestions","orderQuestions","deleteQuestion","addAnswer","changeAnswer","marks","marksAjax","setMark","getGroupMarks","calcAndGetGroupMarks"));
