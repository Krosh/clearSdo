...
class AccessFilter extends CFilter {
    public function preFilter($filterChain) {
        ...
        $rules[ROLE_TEACHER] = array_merge($rules[ROLE_STUDENT],array("editCourse","addTeacherToCourse","getTeachers","deleteTeacher","addGroupToCourse","getGroups","deleteGroup","addMaterial","getMaterials","addExistMaterial","deleteMaterial","orderMaterial","create","edit","getQuestions","orderQuestions","deleteQuestion","addAnswer","changeAnswer","marks","marksAjax","setMark","getGroupMarks"));
