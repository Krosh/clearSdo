...
//        Yii::app()->clientScript->registerCoreScript('jquery.ui');
        ...
        $rules[ROLE_STUDENT] = array("","webinar","userConfig","getMaterial","noAccess","logout","viewCourse","startTest","question","endTest","nextQuestion","skipQuestion","endTest","viewTestResults","news","getCourses");
