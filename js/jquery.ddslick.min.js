    ...
    methods.init = function (options) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                if (options.needTextBox)
                {
                    this.searchInput = $("<input type = 'text' placeholder='"+options.placeholderTextBox+"'>");
                    obj.find('.dd-selected').append(this.searchInput);
                    this.searchInput.keyup(function()
                    {
                        var text = $(this).val();
                        console.log($(obj));
                        console.log($(obj).find(".dd-container"));
                        $(obj).each(function(){
                            var i = 0;
