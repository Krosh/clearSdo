...
class Uploader extends CI_Controller {
	...
	public function upload ($lang='english')
	{
		...
		$conf['img_path']			= $this->config->item('img_path',		'uploader_settings')."/".$userCode;
		...
		$config['upload_path']		= $this->config->item('upload_path',	'uploader_settings')."/".$userCode;
...
//            $result['result']		= $conf['img_path'].DIRECTORY_SEPARATOR.$userCode;
