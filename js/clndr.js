...
(function (factory) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'>previous</span></div><div class='month'><%= moment(month.date).locale('ru').format('MMMM YYYY') %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'>next</span></div>" +
    "</div>" +
    ...
    "<div class='events-list'>" +
        "<% if(eventsThisMonth) { %>" +
            "<% _.each(eventsThisMonth, function(event) { %>" +
                "<div class='event'>" +
                    "<i class='yelbtn'></i> <%= moment(event.date).locale('ru').format('DD MMMM') %> — <a href='<%= event.url %>'><%= event.title %></a>" +
                "</div>" +
            "<% }); %>" +
        "<% } %>" +
    "</div>" +
